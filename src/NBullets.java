...
class ExamplesNBullets {
  ...
  ILoBullet someBullsR = new ConsLoBullet(this.b7,
      new ConsLoBullet(this.b4, new ConsLoBullet(this.b3,
          new ConsLoBullet(this.b2, new ConsLoBullet(this.b1, new MtLoBullet())))));
